...
# create the database and the table habit
...
def predefined(db):
    cur = db.cursor()
    predefined_list = [('Swim', 'Daily', 'health', '2023-02-01', '2023-02-02', 1),
                       ('Walk', 'Daily', 'health', '2023-02-01', '2023-02-02', 1),
                       ('Yoga', 'Weekly', 'mindfulness', '2023-02-01', '2023-02-08', 1),
                       ('Code', 'Daily', 'become better', '2023-02-01', '2023-02-02', 1),
                       ('Meditate', 'Weekly', 'mindfulness', '2023-02-01', '2023-02-08', 1)]
...
def add_habit_daily(db, name, description, periodicity):
    cur = db.cursor()
...
def add_habit_weekly(db, name, description, periodicity):
    cur = db.cursor()
    completion = datetime.today().date()
